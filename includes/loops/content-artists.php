...
<?php if(have_posts()): while(have_posts()): the_post();?>
    <article role="article" id="post_<?php the_ID()?>">
        <header>
            ...
            <h4>
              <em>
                <span class="text-muted author">Posted on</span>
        ...
        <section>
            ...
            <?php the_content( __( '&hellip; ' . __('Continue reading', 'bst' ) . ' <i class="glyphicon glyphicon-arrow-right"></i>', 'bst' ) ); ?><a style="float:right;" href="<?php the_permalink(); ?>"><i class="fa fa-arrow-circle-o-right fa-2x" aria-hidden="true"></i></a>
        </section>
